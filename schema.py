...
#
STAGE_STRS = ["New tournament",
              "Player roster created",
...
assert len(STAGE_STRS) == len(TournStage)  # not ensured by zip
TournStatus = dict(zip(TournStage, STAGE_STRS))
...
class TournInfo(BaseModel):
    ...
    def save(self, *args, **kwargs):
        ...
        if 'stage_compl' in self._dirty:
            ...
            self.status = TournStatus[self.stage_compl]
