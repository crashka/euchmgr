 ...
 *   https://datatables.net/download/#dt/dt-2.3.5/cc-1.1.1/fc-5.0.5
 *
 * Included libraries:
 *   DataTables 2.3.5, ColumnControl 1.1.1, FixedColumns 5.0.5
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.3.5/cc-1.1.1/fc-5.0.5",
...
(function( factory ){
	if ( typeof define === 'function' && define.amd ) {
		// AMD
		define( ['jquery', 'datatables.net-dt', 'datatables.net-columncontrol'], function ( $ ) {
			return factory( $, window, document );
		} );
	}
	else if ( typeof exports === 'object' ) {
